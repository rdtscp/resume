      ...
      <div className="columns">
        ...
        <div className="column is-two-thirds">
          ...
          <WorkEntry title="Software Engineer II" company="FactSet" location="London" date="August 2018 - Present" endyear={(new Date()).getFullYear()}>
            ...
            <br />
            <li> C++/Python: Used profiling driven methodology to improve databases disk footprint and cold read performance by up to 5x(5s to 1s), by using bloom filters. Put together a low risk deployment plan to ensure smooth release. </li>
            ...
            <li> Evaluation of systems scalability with respect to onboarding new clients or providing substantial new features to clients. Required working with multiple teams (globally), having a deep understanding of our product, and gaining solid understanding of other systems which use our product. </li>
            <li> Regular maintenance of a legacy codebase. Including but not limited to: bugfixes, refactors (duplicate/dead code elimination), and memory leak fixes.  </li>
            <li> Debugging crashes in production under pressure. </li>
          </WorkEntry>
          <br />
